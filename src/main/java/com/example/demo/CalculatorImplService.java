    ...
    extends Service
{
    ...
    public CalculatorI getCalculatorImplPort() {
        return super.getPort(new QName("http://demo.example.com/", "CalculatorImplPort"), CalculatorI.class);
    }
    ...
    public CalculatorI getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.example.com/", "CalculatorImplPort"), CalculatorI.class, features);
    }
