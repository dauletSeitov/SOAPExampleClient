...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://demo.example.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://demo.example.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://demo.example.com/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://demo.example.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://demo.example.com/", "subtractResponse");
    private final static QName _Divide_QNAME = new QName("http://demo.example.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://demo.example.com/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://demo.example.com/", "multiply");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.example.com/", name = "multiply")
